...
<div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="        <?php echo site_url('login');?>" method="post">
                    ...
                    <font color="black"> <p class="col-sm-3">Nama Pengguna </p></font>
                    ...
                    <div class="form-group">
                    <font color="black"><p class="col-sm-3">Kata Sandi </p></font>
                        <div class="col-sm-9">
    ...
    <div class="col-md-8 ">
    <font color="red"><h4 align="center" >Aplikasi Manajemen Asset IT PMI</h4></font><hr class="line-title"> 
